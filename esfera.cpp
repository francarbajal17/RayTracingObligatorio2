...
esfera::esfera(vec3 center, double radius, color ambient, color especular, color difuso, double indice_reflexion, double indice_refraccion, double indice_especular, double indice_transparencia) {
	this->center = center;
	this->radius = radius;
